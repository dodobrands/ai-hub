...
COMPANY_CONFIG=(KAITEN_DOMAIN BUILDIN_SPACE_ID)
COMPANY_OPTIONAL=(GENIE_HOST GENIE_SPACE_ID)
PERSONAL_TOKENS=(KAITEN_TOKEN BUILDIN_UI_TOKEN)
PERSONAL_OPTIONAL=(GENIE_TOKEN)
...
NONSECRET_WHITELIST=(KAITEN_DOMAIN BUILDIN_SPACE_ID GENIE_HOST GENIE_SPACE_ID)
